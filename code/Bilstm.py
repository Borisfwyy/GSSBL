...
def run_bilstm(
    ...
    print("BiLSTM", "Using subword" if use_subword else "Using main word", f"Embedding: {word_vec_path}, Device: {device}, LR={LR}, repeat={repeat}")
    ...
    for run in range(1, repeat + 1):
        ...
        if savemodel:
            ...
            print(f"Model of run {run} saved to {model_path}")
        ...
        if savecanshu:
            ...
            print(f"Threshold metrics of run {run} saved to {thresh_csv_path}")
